...
ACTION,
FOREIGN KEY(departmentID) REFERENCES Department(departmentID) ON DELETE NO
ACTION);
...
FOREIGN KEY(DepartmentID) REFERENCES Department(DepartmentID) ON DELETE NO
ACTION,
FOREIGN KEY(Doctor_SSN) REFERENCES Doctor_WORKS_IN(Doctor_SSN) ON DELETE
NO ACTION);
...
create table Medical_Record_BELONGS_TO (
recordID INTEGER NOT NULL,
disease VARCHAR(100),
date DATE,
Patient_SSN CHAR(11) NOT NULL,
FOREIGN KEY(Patient_SSN) REFERENCES Patient(Patient_SSN) ON DELETE NO
ACTION,
...
FOREIGN KEY(Doctor_SSN) REFERENCES Doctor_WORKS_IN(Doctor_SSN) ON DELETE
NO ACTION,
FOREIGN KEY(recordID) REFERENCES Medical_Record_BELONGS_TO(recordID) ON
DELETE CASCADE);
